package com.osvaldsoza.petzapi.config.openapi;
...
public class SpringFoxConfig implements WebMvcConfigurer {
	...
	public Docket apiDocket() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.osvaldsoza.petzapi.controller")).build()
				...
				.apiInfo(apiInfo())
				.tags(new Tag("Clientes", "Gerencia os endpoints dos clientes"),
						new Tag("Pets", "Gerencia os endpoints dos pets"));
	}

	public ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Petz API").description("API para clientes e seus pets").version("1.0")
				.contact(new Contact("Petz", "https://www.petz.com.br", null)).build();
	}
